...
test('game 2 buy pet piplup', () => {
    ...
    assert.strictEqual(demo_game_2.coins, 200 - demo_game_2._pets['piplup'][0]._price);
    assert.strictEqual(demo_game_2._pets['piplup'][0]._hp, 100);
});
...
test('game 3 check changAllHp', () => {
    ...
    const total_cost = demo_game_3._pets['piplup'][0]._price + demo_game_3._pets['turtwig'][0]._price + demo_game_3._pets['eevee'][0]._price;
